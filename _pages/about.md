...
<div style="margin-top: 1em;">
  <p style="margin-bottom: 0.5em;">
    ...
    <strong>Reasoning and Decision Making:</strong> Reinforcement Learning, Exploration, Uncertainty Quantification, Bayesian Inference, Meta-Learning, Test-Time Algorithm, In Context Learning, LLM Reasoning, and Foundation Models for Decision Making
  </p>
  ...
  <p style="margin-bottom: 0.5em;">
    ...
    <strong>AI + X:</strong> Applications in Operations Research, Societal Systems, and Scientific Discovery
  </p>
</div>
